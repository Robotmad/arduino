...
/*
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * + Pin number + 7003311 Brd pin  |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * |            | Digital Low      |        |                 |
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 ...
 * | 13         | LED A            |  PB10  | LED             | EIC/EXTINT[10]                                                 SERCOM4/PAD[2]  TC5/WO[0]    TCC0/WO[4]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * |            | Analog Connector |        |                 |
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
...
/* Types used for the table below  - defined in WVariant.h*/
...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  5, PIO_SERCOM, 		(PIN_ATTR_NONE), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_NONE }, // RX: SERCOM0/PAD[1] EX_RXD
  { PORTA,  4, PIO_SERCOM, 		(PIN_ATTR_NONE), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_NONE }, // TX: SERCOM0/PAD[0] EX_TXD
  
  // 2..7
  // Digital Low
  { PORTA, 28, PIO_DIGITAL, 	(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_8 },		// T1
  { PORTB, 11, PIO_DIGITAL, 	(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_11},		// nSleep to DRV8833
  { PORTA, 20, PIO_DIGITAL, 	(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_4 },		// nFault from DRV8833 
  { PORTB,  9, PIO_DIGITAL, 	(PIN_ATTR_DIGITAL), ADC_Channel3,	NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_9 },		// GInt from MPU9250 	(A6)
  { PORTA,  3, PIO_DIGITAL,		(PIN_ATTR_DIGITAL), ADC_Channel1,	NOT_ON_PWM,	NOT_ON_TIMER,	EXTERNAL_INT_3 },		// TP1					(A7)
  { PORTB, 22, PIO_DIGITAL, 	(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_6 },		// BLE_EN to MDBT40
  ...
  { PORTA, 18, PIO_TIMER_ALT,	(PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),	No_ADC_Channel,	PWM0_CH2,	TCC0_CH2, 		EXTERNAL_INT_2 },	// TCC0/WO[2]
  ...
  { PORTA,  7, PIO_TIMER,		(PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),		ADC_Channel7,	PWM1_CH1,	TCC1_CH1,		EXTERNAL_INT_7 },	// TCC1/WO[1] (A8)
  
  // 13 (LED)
  { PORTB, 10, PIO_OUTPUT, 		(PIN_ATTR_DIGITAL), 								No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER,	EXTERNAL_INT_NONE }, // LED A (Red) Output Only
  ...
  { PORTA,  8, PIO_ANALOG,		(PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),		ADC_Channel16,	PWM0_CH0,	TCC0_CH0,		EXTERNAL_INT_NMI },	// A2 = ADC/AIN[3]
  { PORTA,  9, PIO_ANALOG,		(PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),		ADC_Channel17,	PWM0_CH1,	TCC0_CH1,		EXTERNAL_INT_9 },	// A3 = ADC/AIN[4]
  { PORTA, 10, PIO_ANALOG,		(PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),		ADC_Channel18,	NOT_ON_PWM, NOT_ON_TIMER,	EXTERNAL_INT_5 },	// A4 = ADC/AIN[5]
  { PORTA, 11, PIO_ANALOG,		(PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),		ADC_Channel19,	NOT_ON_PWM, NOT_ON_TIMER,	EXTERNAL_INT_2 },	// A5 = ADC/AIN[10]
  
  // 20..21 - I2C pins (SDA/SCL)
  // -------------------------
  { PORTB,  2, PIO_SERCOM,		(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_2 }, // SDA: SERCOM5/PAD[0] MPU9250
  { PORTB,  3, PIO_SERCOM,		(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_3 }, // SCL: SERCOM5/PAD[1] MPU9250

  // 22..25 - UART pins for MDBT40
  // ----------------------
  { PORTA, 12, PIO_SERCOM_ALT,	(PIN_ATTR_NONE), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_12 }, // RX:  SERCOM4/PAD[0]
  { PORTA, 13, PIO_SERCOM_ALT, 	(PIN_ATTR_NONE), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_13 }, // TX:  SERCOM4/PAD[1]
  { PORTA, 14, PIO_SERCOM_ALT,	(PIN_ATTR_NONE), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_14 }, // CTS: SERCOM4/PAD[2]
  { PORTA, 15, PIO_SERCOM_ALT,	(PIN_ATTR_NONE), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_15 }, // RTS: SERCOM4/PAD[3]

  // 26 - LEDS (PA06)
  // ----------------
  { PORTA,  6, PIO_OUTPUT,		(PIN_ATTR_DIGITAL),	No_ADC_Channel,	NOT_ON_PWM,	NOT_ON_TIMER,	EXTERNAL_INT_NONE }, // used as output only

  // 27..29 - USB
  // --------------------
  { PORTA, 21, PIO_COM, 		(PIN_ATTR_NONE), 	No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_NONE }, 	// USB Host enable  
  ...
  // ----------------------
  // 30 48MHz GCLK[0]
  { PORTA, 27, PIO_DIGITAL, 	(PIN_ATTR_NONE),	No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, 	EXTERNAL_INT_NONE },	// Disabled
   
  // 31 32.768kHz GCLK[1] - to NRF51822 on MDBT40
  { PORTB, 23, PIO_DIGITAL,		(PIN_ATTR_NONE),	No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER,	EXTERNAL_INT_NONE },	// GCLK[1] 327678Hz (T3)
    
  
  // 32..33 - UART (Spare) {Could also be used for input, output or timer functionality}
  // ----------------------
  // 32/33 - EDBG/UART
  { PORTA, 22, PIO_SERCOM, 		(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 }, // TX: SERCOM3/PAD[0]
  { PORTA, 23, PIO_SERCOM,		(PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 }, // RX: SERCOM3/PAD[1]
...
//{ PORTA, 28, PIO_PWM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM0_CH7, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // Dummy to keep pin numbers in sequence
...
// nRF51822 serial connection - ultimately we want this to support RTS & CTS
