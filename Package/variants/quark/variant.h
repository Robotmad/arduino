...
#ifndef _VARIANT_ROBOTMAD_QUARK
#define _VARIANT_ROBOTMAD_QUARK
...
// Serial4
#define PIN_SERIAL4_RX       (22ul)
#define PIN_SERIAL4_TX       (23ul)
#define PIN_SERIAL4_CTS      (24ul)
#define PIN_SERIAL4_RTS      (25ul)
#define PAD_SERIAL4_TX       (UART_TX_PAD_0)
#define PAD_SERIAL4_RX       (SERCOM_RX_PAD_1)
#define PAD_SERIAL4_CTS      (SERCOM_CTS_PAD_2)
#define PAD_SERIAL4_RTS      (SERCOM_RTS_PAD_3)
